    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (Score entity : entities) {
                ...
                out.printf("<td class=\"name\" id=\"%d\" >%s</td>", counter++, entity.getScore());
                out.printf("<td class=\"name\" id=\"%d\" >%s</td>", counter++, entity.getPlayerid().getId());
                out.printf("<td class=\"date\" id=\"%d\" >%s</td>", counter++, entity.getSubmission());
